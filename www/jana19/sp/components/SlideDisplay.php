...
// s bootstrapem nemám zkušenosti defakto žádné, takže jsem se musela podívat do gitu na ty třídy, co se tu používají
?>

    <div class="carousel slide my-4" id="carouselExampleIndicators" data-ride="carousel">
        <ol class="carousel-indicators">
            <?php foreach ($slides as $index=>$slide) : ?>
                <li data-target="#slide" data-slide-to="<?php echo $index; ?>" class="<?php echo $index == 0 ? 'active' : ''; ?>"></li>
            <?php endforeach; ?>
        </ol>
