...
class GoodsDB extends Database
{
    ...
    {
        $sql = "INSERT INTO cv08_goods (name, price, description, img) VALUES (:name, :price, :description, :img)";
        $this->runQuery($sql, [
            'name' => $data['name'],
            'price' => $data['price'],
    ...
    {
        $sql = "SELECT * FROM cv08_goods WHERE ";
