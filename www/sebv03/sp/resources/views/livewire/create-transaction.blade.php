        ...
        <div class="mb-6">
            ...
            <form method="POST" action="{{ route('account.make-payment',['account' => $account->id]) }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input wire:model.live.debounce.50ms="transactionAmount" wire:keydown.debounce.50ms="amountChanged" type="number" id="amount" name="amount" min="0" max="{{$account->balance}}" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
