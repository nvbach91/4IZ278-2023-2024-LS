...
$f = $field->getField($idfield);
$_SESSION['price'] = $f->price;
?>



<title>Rezervace <?php echo $f->name; ?></title>
</head>
                    ...
                    <div class="row mt-5 p-0 mx-0">
                        <div class="col-6 p-0">
                            <button class="btn btn-warning" type="button" data-bs-toggle="collapse"
                                data-bs-target="#collapseSport" aria-expanded="false" aria-controls="collapseSport"
                                onclick="getSports('<?php echo $idfield; ?>');">
                                Upravit sporty
                            </button>
                            <button class="btn btn-warning" type="button" data-bs-toggle="collapse"
                            ...
                            <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete">Smazat
                                halu</button>
                        </div>
                        <div class="col-6 text-end p-0">
                            <button onclick="confirmReservation()" class="btn btn-success disabled"
                                id="confirm-button">Rezervace</button>
                        </div>
