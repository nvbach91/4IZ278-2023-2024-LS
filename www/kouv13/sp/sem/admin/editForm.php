        ...
        <form action="admin/editField.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control focus-ring focus-ring-success" id="floatingInput"
                    placeholder="Pepa Novák" name="name" value="<?php echo $f->name; ?>">
                <label for="floatingInput">Jméno</label>
            </div>
            <div class="form-floating mb-3">
                <textarea class="form-control focus-ring focus-ring-success" placeholder="Popisek"
                    id="floatingTextarea2" style="height: 100px"
                    name="description"><?php echo $f->description; ?></textarea>
                <label for="floatingTextarea2">Popisek</label>
            </div>
            <div class="form-floating mb-3">
                <input type="number" class="form-control focus-ring focus-ring-success" id="floatingInput"
                    placeholder="kapacita" name="capacity" value="<?php echo $f->capacity; ?>">
                <label for="floatingInput">Kapacita</label>
            </div>
            <div class="form-floating mb-3">
                <input type="number" class="form-control focus-ring focus-ring-success" id="floatingInput"
                    placeholder="cena" name="price" value="<?php echo $f->price; ?>">
                <label for="floatingInput">Cena</label>
            </div>
            <input type="hidden" value="<?php echo $f->field_id; ?>" name="id">
