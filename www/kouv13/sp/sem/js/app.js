function loadCalendar(date) {
    ...
    xmlhttp.open("GET", "/sem/ajax/loadCalendar.php?date=" + date, true);
    xmlhttp.send();
}
...
document.addEventListener('DOMContentLoaded', function () {
    if (window.location.pathname === '/sem/u/reservation/' || window.location.pathname === '/sem/admin/field.php') {
        addReservationListeners();
        addRadioListeners();
    }
});
...
function editSports(idField, idSport) {
    ...
    xmlhttp.open("GET", "/sem/ajax/editSports.php?idField=" + idField + "&idSport=" + idSport, true);
    xmlhttp.send();
}
...
function getSports(idField) {
    ...
    xmlhttp.open("GET", "/sem/ajax/getSports.php?idField=" + idField, true);
    xmlhttp.send();
}
