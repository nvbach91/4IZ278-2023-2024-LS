...
if (!empty($_POST)) {
    ...
    if (empty($errors)) {
        try {
            $stmnt = $db->prepare("INSERT INTO cv08_goods (name, price, description, img) VALUES (:name, :price, :description, :img)");
...
<main style="height: 100vh;">
    <div style="width: 60%; margin: 50px auto;">
        ...
        <form method="POST" action="<?php $_SERVER['PHP_SELF'] ?>">
            ...
            <div class="form-group">
                <label for="exampleInputEmail1">Popis</label>
                <input type="text" class="form-control" name="descr" placeholder="Je to naprosto úžasný produkt. Buy it!">
            </div>
            <div class="form-group">
