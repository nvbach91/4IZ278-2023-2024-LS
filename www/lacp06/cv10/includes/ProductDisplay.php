  ...
  <?php foreach ($products as $product) : ?>
    <div class="card" style="width: 18rem;">
      ...
      <div class="card-body">
        ...
        <a href="buy.php/?good_id=<?php echo $product['good_id']; ?>" class="btn btn-primary">Buy</a>
        <?php if ($privileges > 1) : ?>
          <a href="edit-item.php?good_id=<?php echo $product['good_id']; ?>" class="btn btn-primary">Edit</a>
          <a href="delete-item.php/?good_id=<?php echo $product['good_id']; ?>" class="btn btn-primary">Delete</a>
        <?php endif; ?>
      </div>
    </div>
  <?php endforeach; ?>
