...
if ('POST' == $_SERVER['REQUEST_METHOD']) {
    ...
    $zricenina = null;
    $pristresek = null;
    if(isset($_POST['vyhlidka'])){$vyhlidka = 'vyhlidka';};
    if(isset($_POST['rybnik'])){$rybnik = 'rybnik';};
    if(isset($_POST['ohniste'])){$ohniste = 'ohniste';};
    if(isset($_POST['zricenina'])){$zricenina = 'zricenina';};
    if(isset($_POST['pristresek'])){$pristresek = 'pristresek';};
    ...
    $description = htmlspecialchars(stripcslashes($description));
