                        ...
                        <div class='modal-body'>
                            <form action='index.php' method='POST'>
                                <div class='form-group'>
                                    ...
                                    <input type='text' class='form-control' id='editTitle<?php echo $meal['meal_id']; ?>' name='title' value='<?php echo $meal['title']; ?>' required>
                                </div>
                                <div class='form-group'>
                                    <label for='editDescription<?php echo $meal['meal_id']; ?>'>Description</label>
                                    <textarea class='form-control' id='editDescription<?php echo $meal['meal_id']; ?>' name='description' required><?php echo $meal['description']; ?></textarea>
                                </div>
                                <div class='form-group'>
                                ...
                                <div class='form-group'>
                                    ...
                                    <input type='text' class='form-control' id='editPickupRoom<?php echo $meal['meal_id']; ?>' name='pickup_room' value='<?php echo $meal['pickup_room']; ?>'>
                                </div>
                                <div class='form-group'>
