...
export default function Welcome({auth, laravelVersion, phpVersion, universities}) {
    ...
    return (
        <>
            <Head title="Welcome"/>
            <div className="bg-gray-50 text-black/80 dark:bg-black/90 dark:text-white/80">
                <div
                    className="relative min-h-screen flex flex-col items-center selection:bg-blue-700 selection:text-white">
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        <header className="flex justify-between items-center py-4 text-bold">
                            <Link href="/">
                                <img src="/images/logo-dark.svg" alt="study-sync" className="h-[40px]"/>
                            </Link>
                        ...
                        <main className="my-6">
                            <div className="flex flex-col justify-center items-center">
                                <h1 className="text-3xl lg:text-5xl font-bold">Welcome to StudySync platform!</h1>
                                <p className="mt-4 text-lg">
                                    A platform for students and teachers to collaborate and learn together.
                                </p>
                            ...
                            <div className="mt-12 flex flex-col items-center">
                                <h2 className="text-2xl font-bold">Most Popular Schools</h2>
