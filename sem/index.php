                ...
                <div id="carouselExampleCaptions" class="carousel slide mb-2" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="imgs/basket.jpeg" class="d-block w-100" alt="Sportoviště na basketball">
                        ...
                        <div class="carousel-item">
                            <img src="imgs/tenis.jpeg" class="d-block w-100" alt="Sportoviště na tenis">
                            <div class="gradient-overlay"></div>
                            <div class="carousel-caption d-none d-md-block">
                                <h5>Hřiště 3</h5>
                        ...
                        <div class="carousel-item">
                            <img src="imgs/volejbal.jpeg" class="d-block w-100" alt="Sportoviště na Volejbal">
                            <div class="gradient-overlay"></div>
                            <div class="carousel-caption d-none d-md-block">
                                <h5>Hřiště 8</h5>
                                <p>Volejbal se u nás hraje skvěle!</p>
                            </div>
                        </div>
                    </div>
